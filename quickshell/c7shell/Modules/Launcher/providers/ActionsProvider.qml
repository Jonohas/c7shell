...
Item {
  ...
  readonly property var settingsActions: ["appearance", "displays", "wifi", "bluetooth", "audio"]
    .map(p => ({
      title: `${p} settings`,
  ...
  function lock() { PowerActions.lock() }
