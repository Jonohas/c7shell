...
Rectangle {
  ...
  // A list row is a raised surface on top of a panel that is already glass; a
  // toast has nothing under it, so it IS the glass -- and the glass belongs to
  // GlassPanel, which is where the blur invariant's alpha is kept.
  color: root.glass ? "transparent" : Theme.surface04
